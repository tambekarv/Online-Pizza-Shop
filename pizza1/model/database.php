...
if (gethostname() === 'topcat') {
    $username = 'vinit';  // CHANGE THIS to your cs.umb.edu username
    $password = 'vinit';  // CHANGE THIS to your mysql DB  password on topcat 
    $dsn = 'mysql:host=localhost;dbname='. $username . 'db';
} else {  // dev machine, can create pizzadb
    $dsn = 'mysql:host=127.0.0.1;dbname=pizzadb';
    $username = 'pizza_user';
